...
<h2>* 첨부파일 경로에 파일 업로드가 안 되는 오류 </h2>

해당 폴더에 대한 권한 문제 


<h3>* sudo chmod -R 777 files/ </h3>

소유자, 그룹, 기타 모두 읽기, 쓰기, 실행 권한을 부여하는 명령어 

chmod 명령어는 파일이나 디렉토리의 권한을 변경하는 명령어 ex) chmod [옵션] [권한] [대상]

권한은 읽기(r), 쓰기(w), 실행(x), 권한 없음(-) 


대상은 소유자(u), 그룹(g), 기타사용자(o) ,모든 사용자(a) 
