...
<body>
	...
	<form id="insertForm" action="${path}/room/insert" method="post" onsubmit="checkInsertForm(event)"
		...
		<div class="body">
			<div class="mainContainer"
				...
				<div class="subContainer">
					<h3>- 객실 관리 > 객실 추가</h3>
					<div>
						<label>호수</label><input name="roomNo" class="roomNo" type="text" onkeyup="setNum(this);"></input>
					</div>

					<div>
						<label>룸 타입</label><select name="roomType" class="roomType">
					...
					<div>
						<label>최대 인원</label><input name="max" type="text" class="max" onkeyup="setNum(this);"></input>
					</div>
					<div>
						<label>가격</label><input name="price" type="text" class="price" onkeyup="setNum(this);"></input>
					</div>
					<div>
						<label>객실 이미지</label> <input type="file" class="file"
							name="files"></input>
					</div>
					<div>
	...
	<div class="modal-wrap" style="display: none;">
		...
		<div class="modal">
		 <form id="modForm" action="${path}/room/modify" method="post" enctype="multipart/form-data" onsubmit="checkModForm(event)">
